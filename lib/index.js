  ...
  server.on('response', (request) => {
    ...
    const payload = {
      ...
      httpRequest: {
        ...
        requestUrl: `${request.connection.info.uri}${request.raw.req.url}`,
        requestSize: request.plugins.piles.requestSize,
        responseSize: request.plugins.piles.responseSize,
